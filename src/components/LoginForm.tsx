...
function LoginForm({ authType }: { authType?: string }): JSX.Element {
  ...
  return (
    <form
      className="w-full md:w-11/12 lg:w-1/3 xl:w-1/3 flex flex-col px-6 pt-12 mt-12 md:pt-12 md:mt-12 lg:pt-16 xl:pt-16 lg:mt-16 xl:mt-16"
      style={{ background: "rgb(244, 246, 248)" }}
    >
